...
void display()
{
    ...
    stroke_output(12.0, 1, "p/P-->Launch the` Rocket");
    stroke_output(-2.0, 0, "KARTIK HEGADI");
    stroke_output(-2.0, -1, "KUNTHUNATH M N");

    stroke_output(12.0, -2, "KEERTI S PATIL");
    stroke_output(17.0, -3, "MEGHANA");
    stroke_output(12.0, 2, "Rocket Launching with Satelite simulation ");

    // stroke_output(-2.0, 3, "p/P-->5Launch the` Rocket");
